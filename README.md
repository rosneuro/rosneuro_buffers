...
The package provides a generic interface to implement buffers. Different types of buffers can be independently developed and dynamically loaded through the interface.
...
**Example of explicit configuration of a RingBuffer**
...
**Example of nameserver configuration of a RingBuffer**
...
<launch>
  ...
  <node name="myringbuffer" pkg="rosneuro_buffers_ringbuffer" type="myringbuffer" output="screen"/>
</launch>
```
